        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :active="request()->is('/')"> Dashboard</x-nav-link>
                    <x-nav-link :active="request()->is('/products')"> Products</x-nav-link>
                    <x-nav-link :active="request()->is('/suppliers')"> Suppliers</x-nav-link>
                </div>
            </div>
