    ...
    <div class="m-auto">
        <x-form.form method="POST" class="md:w-[50vw] sm:w-[80vw]" action="/suppliers">
            <x-form.field>
                ...
                <x-form.input name="name" placeholder="Factory Inc."/>
                <x-form.error name="name"/>
            </x-form.field>
            <x-form.field>
                <x-form.label for="address">Address</x-form.label>
                <x-form.input name="address" placeholder="Av. Evergreen #22, Springfield"/>
                <x-form.error name="address"/>
            </x-form.field>
            <x-form.field>
                <x-form.label for="contact_person">Contact person</x-form.label>
                <x-form.input name="contact_person" placeholder="John Doe"/>
                <x-form.error name="contact_person"/>
            </x-form.field>
            <x-form.field>
                <x-form.label for="email">Contact E-mail</x-form.label>
                <x-form.input name="email" placeholder="factory@inc.com"/>
                <x-form.error name="email"/>
            </x-form.field>
            <x-form.field>
                <x-form.label for="phone">Contact number</x-form.label>
                <x-form.input name="phone" placeholder="+5037777555"/>
